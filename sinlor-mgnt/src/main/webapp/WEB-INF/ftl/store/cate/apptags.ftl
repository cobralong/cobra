            ...
            <#include "lib/alert.ftl">
                <div class='main-content'>
                	 <div class="well form-inline">
                        <form id="searchForm" name="searchForm" enctype="multipart/form-data" action="${rc.contextPath}/auth/store/cate/addapptag" method="post">
                            ...
                            <#if values??>
                            	<#list values as value>
                            		<tr>
	                                    ...
	                                    <td>${ value.apps! }</td>
	                                    <td> <a class="btn btn-info query" href="${rc.contextPath}/auth/store/cate/apptagdetail?id=${value.id}">详情</a>
                                	</tr>
                                </#list>
                            </#if>
                            </tbody>
