                ...
                <div class='main-content'>
                    <div class="well form-inline">                     
                        <#if data??>                        
							...
							<form id="searchForm" name="searchForm" enctype="multipart/form-data" action="${rc.contextPath}/auth/store/cate/modifyvideocateicon" method="post">
		...
		<script type="text/javascript">
            $("input.editortitle").bind("blur", function () {
                ...
                bootbox.confirm(actionMsg, function(result) {
		 			...
		 			var postUrl = "${rc.contextPath}/auth/store/cate/modifyvideocatename";
