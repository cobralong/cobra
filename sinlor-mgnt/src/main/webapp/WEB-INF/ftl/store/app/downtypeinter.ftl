            ...
            <#include "lib/alert.ftl">
                <div class='main-content'>
                            ...
                            <form id="searchForm" name="searchForm" action="" method="post">
		                        ...
		                        <input type="hidden" id="pager_total" name="pager.total" value="${para.pager.total}">
                                 <div class="input-prepend">
                                    ...
                                    <input class="span2 info" name="rootId" type="text" placeholder="ID" value="">
                            	</div>
                                <div class="input-prepend">
                    ...
                    <div id="div_add" class="well form-inline">
                        <div class='main-action'>
                            <form id="searchForm" name="searchForm" action="${rc.contextPath}/auth/store/app/adddowntypeintervention" method="post">
                                <div class="input-prepend">
                                    <span class="add-on">ID</span>
     ...
     <script>
	    $(document).ready(function(){
 		...
 		$("input.search").bind("blur", function(){
 			...
 			var btn = $("button.add");
            var posting = $.post("${rc.contextPath}/auth/store/dailyrecom/search", {"id": rid, "type": 1});
 		...
 		$("button.delete").bind("click",function(){
 			...
 			var postUrl = "${rc.contextPath}/auth/store/app/modifydowntypeintervention.json"; 			
