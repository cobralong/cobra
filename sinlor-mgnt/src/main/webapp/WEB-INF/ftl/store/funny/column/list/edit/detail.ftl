                    ...
                    <div class="well form-inline">                     
                        <#if value??>
                            <div class="input-prepend">
								<label class="add-on">详情页面ID</label>
								<div class="controls input-prepend">
                            		<input type="text" name="columnDetailId" value="${value.columnDetailId}" readonly="readonly"/>
                            	</div>
							</div>                      
							<div class="input-prepend">
								<label class="add-on">标题</label>
								<div class="controls input-prepend">
									<input class="editortitle" name="title" type="text" default_id = "${value.id?c}" flag="0" pre_value = "${value.title}" value="${value.title!}"/>
								</div>
							</div>
							<div class="input-prepend">
								<label class="add-on">发布时间</label>
								<div class="controls input-prepend">
                                    <input class="editortitle" name="st" type="text" default_id = "${value.id?c}" flag="1" pre_value = "${value.relaeseTime?string("yyyy-MM-dd HH:mm:ss") }" 
							...
							<div class="control-group">
								...
								<div class="controls input-prepend">
									<img width="600px" height="280px" src="${value.img}" alt="背景图" title="背景图">
								</div>
							</div>
							<form id="searchForm" name="searchForm" enctype="multipart/form-data" action="${rc.contextPath}/funny/client/edit/modifyimg" method="post">
