        ...
        <div class="row-fluid">
            ...
            <#include "lib/alert.ftl">
                <div class='main-content'>
                    ...
                    <div class="well form-inline">
                        <div class='main-action'>
                            <form id="addForm" name="addForm" action="${rc.contextPath}/auth/pcsuite/driver/add" enctype="multipart/form-data" method="post">
                                <div class="input-prepend">
                                	<span class="add-on">操作系统</span>
                                	<select name="system">
		                            	<#list windows as window>
                            ...
                            <table class="table table-striped table-bordered table-condensed" id="itemTable">
                                ...
                                <#if datas??>
                                    ...
                                    <tr>                                        
                                        ...
                                        <td><a class="btn btn-info query" href="${rc.contextPath}/auth/pcsuite/driver/detail?id=${data.id}">详情</a></td>
                                    </tr>
                                    </#list>
                                </#if>
                                </tbody>
     ...
     <script>
	    $(document).ready(function(){
 		...
 		$("span.delete").bind("click",function(){
 			...
 			var postUrl = "${rc.contextPath}/auth/pcsuite/driver/modify.json";
 			var confirmMsg = "";
 			if(status == -1){
 				confirmMsg = "删除当前记录";
 			}else{
