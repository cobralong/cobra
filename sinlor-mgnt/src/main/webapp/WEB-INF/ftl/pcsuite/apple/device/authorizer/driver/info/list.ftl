...
<title>应用汇-管理后台-PC助手授权苹果设备驱动列表</title> <#include "lib/base_source.ftl">
									...
									<div class="input-prepend">
										...
										<div class="input-prepend">
											<span class="add-on">系统架构</span> <select name="arch">
												<#list arches?keys as key> <#if para.arch == key>
						...
						<div class="well form-inline">
							<div class='main-action'>
								<form id="addForm" name="addForm"
									action="${rc.contextPath}/auth/pcsuite/apple/device/authorizer/driver/info/add"
							...
							bootbox
									.confirm(
											...
											function(result) {
												...
												var postUrl = "${rc.contextPath}/auth/pcsuite/apple/device/authorizer/driver/info/modify";
												var postData = "id=" + id
														+ "&status="
														+ setStatus;
