...
<title>应用汇-管理后台-PC助手苹果设备全驱动列表</title> <#include "lib/base_source.ftl">
						...
						<div class="well form-inline">
							<div class='main-action'>
								<form id="addForm" name="addForm"
									action="${rc.contextPath}/auth/pcsuite/apple/device/full/driver/info/add"
	...
	<script>
		$(document).ready(
 		...
 		$("button.defaultdelete").bind("click",function(){
 			...
 			var postUrl = "${rc.contextPath}/auth/pcsuite/apple/device/full/driver/info/modify";
 			if(defaultFlag == 1){
