        ...
        <div class="row-fluid">
            ...
            <#include "lib/alert.ftl">
                <div class='main-content'>
                    ...
                    <div class="well form-inline">
                        <div class='main-action'>
                            <form id="addForm" name="addForm" action="${rc.contextPath}/auth/pcsuite/apple/developer/driver/add" enctype="multipart/form-data" method="post">
                                <div class="input-prepend">
                                	<span class="add-on">iOS系统</span>
                                	<select name="version">
		                            	<#list versions as version>
     ...
     <script>
	    $(document).ready(function(){
 		...
 		$("span.delete").bind("click",function(){
 			...
 			var postUrl = "${rc.contextPath}/auth/pcsuite/apple/developer/driver/modify.json";
 			var confirmMsg = "";
 			if(status == -1){
 				confirmMsg = "删除当前记录";
 			}else{
