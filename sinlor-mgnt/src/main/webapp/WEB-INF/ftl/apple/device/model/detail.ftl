		                    ...
		                    <div class="well form-inline">
		                    	<#if data??>
			                        <div class='main-action'>		                        
										...
										<form id="searchForm" name="searchForm" enctype="multipart/form-data" action="${rc.contextPath}/auth/apple/device/model/modify/icon" method="post">
		...
		<script type="text/javascript">
			$('input.padding').bind("blur", function(e){
				...
				bootbox.confirm("是否对" + properties+ "进行更改,由【"+preValue+"】改为【"+curValue+"】?", function(result){
					...
					var postUrl = "${rc.contextPath}/auth/apple/device/model/modify";
