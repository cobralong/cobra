						...
						<div id="div_add" class="well form-inline">
							<div class='main-action'>
								<form id="addForm" name="addForm"
									action="${rc.contextPath}/auth/apple/device/add"
									method="post">
									<div class="input-prepend">
										<span class="add-on">平台型号</span> 
										<select name="platform" class="search_platform">
											<#list platforms?keys as key>
												<option value="${key}" selected>${platforms[key]}----${key}
											</#list>
										</select>
									</div>
									<div class="input-prepend">
										<span class="add-on">设备颜色</span>
										<select name="colorDictId">
											<#list colors?keys as key>
												<option value="${key}" selected>${colors[key]}----${key}
											</#list>
										</select>
									</div>
