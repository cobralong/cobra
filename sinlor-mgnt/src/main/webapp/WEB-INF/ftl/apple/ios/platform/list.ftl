    ...
    <div class="container-fluid">
                ...
                <div class='main-content'>
                    ...
                    <div id="div_add" class="well form-inline">
                        <div class='main-action'>
                            <form id="searchForm" name="searchForm" action="${rc.contextPath}/auth/apple/ios/platform/add" method="post">
     ...
     <script>
 		$("button.defaultdelete").bind("click",function(){
 			...
 			var postUrl = "${rc.contextPath}/auth/apple/ios/platform/modify";
