	...
	<body>
	            	...
	            	<div class="container span12">
		                ...
		                <div class='main-content'>
		                        ...
		                        <div class='main-action'>
		                            <form id="searchForm" name="searchForm" action="" method="post">
				                        ...
				                        <div class="input-prepend">
		                                	<span class="add-on">应用Id：</span>
		                                	<input class="span4" name="rootId" type="text" placeholder="rootId" value="${para.rootId}">
		                                </div>
		                                <div class="input-prepend">
		                                	<span class="add-on">授权账号：</span>
		                                	<input class="span4" name="appleId" type="text" placeholder="appleId" value="${para.appleId}">
		                                </div>
		                               <div class="input-prepend">
		                    ...
		                    <div id="div_add" class="well form-inline">
		                        <div class='main-action'>
		                            <form id="addForm" name="addForm" action="${rc.contextPath}/auth/authorizer/app/ipa/add"  method="post">
		                                <div class="input-prepend">
		                                	<span class="add-on">纯净版：</span>
		                            ...
		                            <table class="table table-striped table-bordered table-condensed" id="itemTable">
		                                ...
		                                <#if values??>
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td>${value.appleId!}</td>
		                                        <td>
		                                        	${rootIdApplicationSimpleMap[value.rootId?c].name}
		                                        </td>
		                                        <td>${value.installIpaMd5!}</td>
		                                        <td>${value.pureIpaMd5!}</td>
			                                    <td>
			                                    	<#if value.status == 0>
			                                    ...
			                                    <td>
			                                    	<a class="btn btn-info query" href="${rc.contextPath}/auth/authorizer/app/ipa/detail?id=${value.id?c}">详情查看</a>
			                                    </td>
		                                    </tr>
		                                    </#list>
		                                </#if>
	    ...
	    <script>
			...
			$("span.delete").bind("click",function(){
		 			...
		 			var postUrl = "${rc.contextPath}/auth/authorizer/app/ipa/modify.json";
		 			var confirmMsg = "";
		 			if(status == -1){
		 				confirmMsg = "删除当前记录";
		 			}else{
