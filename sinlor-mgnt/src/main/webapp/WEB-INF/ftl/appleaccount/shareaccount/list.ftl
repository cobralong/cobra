	            	...
	            	<div class="container span12">
		                ...
		                <div class='main-content'>
		                    ...
		                    <div id="div_add" class="well form-inline">
		                        <div class='main-action'>
		                            <form id="addForm" name="addForm" action="${rc.contextPath}/auth/appleaccount/shareaccount/add" enctype="multipart/form-data" method="post">
		                                <div class="input-prepend">
		                                	<span class="add-on">iOS系统</span>
		                             		<select name="type">
				                            	<#list types as type>
				                            		<#if para.type == type.type>
				                            			<option value="${type.type}" selected>${type.desc}</option>
				                            		<#else>
				                        				<option value="${type.type}">${type.desc}</option>
				                        			</#if>
				                            	</#list>
		                                ...
		                                <div class="input-prepend">
		                                	<span class="add-on">其它描述：</span>
		                                	<input class="span2" name="info" type="text" placeholder="" value="">
		                                </div>
		                            ...
		                            <table class="table table-striped table-bordered table-condensed" id="itemTable">
		                                ...
		                                <#if values??>
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td>
		                                        	 <a class="btn btn-info query" href="${rc.contextPath}/auth/appleaccount/shareaccount/detail?id=${value.id}">详情</a>
		                                        </td>
		                                        <td>
		                                        	 <a class="btn btn-info query" href="${rc.contextPath}/auth/appleaccount/shareaccount/buyapp/list?appleId=${value.appleId}">已购应用列表</a>
		                                        </td>
		                                    </tr>
		                                    </#list>
		                                </#if>
	 		...
	 		$('.edit_td').click(function() {
	 			...
	 			input.blur(function() {			
	 				...
	 				bootbox.confirm("将帐号【" + accountName  +"】的" + typeName + "由【" + preValue + "】改为【" + curValue + "】?", function(result) {
			 			if(result){
	 						var postUrl = "${rc.contextPath}/auth/appleaccount/shareaccount/modify.json";
