                    		...
                    		<div class="well form-inline">
                        		<div class='main-action'>
                        			<#if value??>
										...
										<form id="searchForm" name="searchForm" enctype="multipart/form-data" action="${rc.contextPath}/auth/appleaccount/authorizer/modify/icon" method="post">
