...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="http://iosmgnt.appchina.com/admin/index">管理后台</a>
...
//填充header
    ...
    $(document).ready(function () {
   		var menus = $.backend.allMenuByName($.backend.opts.rootMenuName,0);   		
    	var content = initHeadMenus(menus);
    //	<!--
        //填充header
     //   var menus = $.backend.allMenuByName($.backend.opts.rootMenuName);
     //   var subMenus = menus.subMenus;

       // var content = "";
     //   for (var i = 0; i < subMenus.length; i++) {
     //       var menu = subMenus[i].menu;
     //       var menus = subMenus[i].subMenus;
            // 有下拉菜单
      //      if (menus.length > 0) {
      //          content += '<li class="dropdown root_menu" id = "menu_' + menu.id + '">' +
       //                 '<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="root_name">'
       ...
       //             content += '<li><a class="navbar-title" id = "menu_' + menus[j].menu.id + '" href="' + $.backend.opts.base + menus[j].menu.url + '">' + menus[j].menu.name + '</a></li>'
        //        }
        //        content += '</ul></li>'
         //   } else {
        //        content += '<li class="root_menu" id = "menu_' + menu.id + '"><a class="navbar-title" href="' + $.backend.opts.base + menu.url + '">' + menu.name + '</a></li>'
