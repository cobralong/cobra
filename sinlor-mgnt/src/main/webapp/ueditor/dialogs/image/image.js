        ...
        uploadComplete: function(r){
            ...
            try{
                ...
                if(json.status != 0){
                    ...
                    Base.callback(me.editor, me.dialog, '', json.message);
                }else{
                    Base.callback(me.editor, me.dialog, json.data.url, json.data.state);
                }
                ...
                me.dialog.find('.edui-image-content').on('drop',function (e) {
                    ...
                    $.each(fileList, function (i, f) {
                        if (/^image/.test(f.type)) {
                            ...
                            xhr.open("post", me.editor.getOpt('imageUrl') + "?type=ajax&editorid=" + editor.id, true);
