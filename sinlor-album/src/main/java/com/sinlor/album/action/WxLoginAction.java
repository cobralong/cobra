...
import com.sinlor.album.model.UserCollectInfoModel;
import com.sinlor.album.model.UserFullInfo;
import com.sinlor.album.model.UserOpenIdInfo;
import com.sinlor.album.service.UserOpenIdInfoService;
import com.sinlor.album.util.AES;
...
import com.sinlor.core.service.AsyncService;
...
public class WxLoginAction {
    ...
    @ResponseBody
    public UserCollectInfoModel getUserCollectAlbum(Integer userId) {
        ...
        UserCollectInfoModel model = new UserCollectInfoModel();
        model.setCollectList(gg);
