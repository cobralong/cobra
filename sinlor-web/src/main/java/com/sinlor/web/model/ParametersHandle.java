...
import com.sinlor.web.utils.CollectionUtils;
import com.sinlor.web.utils.GsonUtils;
import com.sinlor.web.utils.UrlUtils;
...
public interface ParametersHandle<T> {
    ...
    public static final ParametersHandle<String> PS_ACCOUNT_HANDLE = new ParametersHandle<String>() {
