// Copyright 2011 139.com Inc. All Rights Reserved.

package com.sinlor.web.utils;
...
import com.sinlor.web.model.ApiRespWrapper;
import com.sinlor.web.model.ParametersHandle;
import com.sinlor.web.model.PostParametersHandle;
import com.sinlor.web.model.ReturnDataHandle;

/**
 * @author corefee@staff.139.com (Your Name Here)
 * 
 */
public class RemoteDataUtil {
    private static final Logger log = Logger.getLogger(RemoteDataUtil.class);
    public static final int DEFAULT_SO_TIMEOUT_MILLISECONDS = 5000;
    ...
    public static String postRemoteData(String url, String param) throws Exception {
        return postRemoteDataString(url, param, DEFAULT_SO_TIMEOUT_MILLISECONDS, 3);
    }
    ...
    public static String postRemoteDataString(String url, String param, int so_timeout_milliseconds, int try_times)
            throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        do {
            ...
            try {
                ...
                log.warn("Send data to url with param failed. Url:" + url + ", param:" + param, e);
                Thread.sleep(2000);
            } finally {
                IOUtils.close(response);
            }
