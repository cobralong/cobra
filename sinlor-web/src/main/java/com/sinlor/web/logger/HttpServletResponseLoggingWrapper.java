...
/**
 * Created by zhouyanhui on 4/24/15.
 */
...
interface CopyResponseStreamWrapper {
    String getCopy();
}

class CopyPrintWriter extends PrintWriter implements CopyResponseStreamWrapper {
...
class CopyServletOutputStream extends ServletOutputStream implements CopyResponseStreamWrapper {
