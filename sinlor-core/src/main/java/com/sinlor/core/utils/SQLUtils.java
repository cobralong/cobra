...
import com.sinlor.core.DbField.SELECT_ALL_KEY;
import com.sinlor.core.DbField.UNSIGNED_INT;
import com.sinlor.core.DbField.ZERO_ENABLE;
import com.sinlor.core.DbStatus;
import com.sinlor.core.StatusType;
            ...
            for (PropertyDescriptor pd : info.getPropertyDescriptors()) {
                ...
                if (reader != null) {
                    ...
                    if (BeanAnnotatiionUtils.isAnnotationPresent(obj.getClass(), pd.getName(), SELECT_ALL_KEY.class)) {
                        if (StringUtils.equalsIgnoreCase(String.valueOf(DbStatus.ALL_ID_DESC), putObject.toString())
                                || StringUtils.equalsIgnoreCase(DbStatus.ALL_DESC, putObject.toString())) {
                            continue;
                        }
                    }
